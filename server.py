...
async def eff(key: str) -> str:
    """VPS env vars are the single source of truth. Supabase is fallback only."""
...
async def _run_campaign(campaign_id: str) -> None:
    ...
    try:
        ...
        for i, contact in enumerate(contacts):
            ...
            await lk.room.create_room(lk_api_module.CreateRoomRequest(name=room_name, empty_timeout=300, max_participants=5))
